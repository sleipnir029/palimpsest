...
\titre{A Skill-Extensible Agentic Workflow\\
for Provenance-Tracked, Ontology-Aligned\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{scattered-quantity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{eval-methodology.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{skill-mechanism.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{provenance-model.png}
...
{\small
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{2.0cm} >{\raggedright\arraybackslash}p{7.4cm}@{}}
