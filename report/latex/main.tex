...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\textwidth]{scattered-quantity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{eval-methodology.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.58\textwidth]{skill-mechanism.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{provenance-model.png}
